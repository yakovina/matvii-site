...
const STEPS = [
  ...
  { t: 'Контакт', d: 'Перші 2–3 зустрічі — будуємо довіру. Підліток бачить, що тут його чують, а не виховують.' },
      ...
      <div className="group-hero on-dark">
        <div className="wrap group-hero-grid">
          <div>
            ...
            <h1>
              Розмова на рівних — <em>без моралізаторства</em>
            </h1>
            <p className="lead">
              Підлітку не потрібен ще один дорослий з порадами. Потрібен той, хто вислухає без
              оцінок і допоможе розібратися: в собі, у стосунках, у тому, чого хочеться далі.
              Батькам — пояснюю, як підтримувати, не тиснучи.
            </p>
          ...
          <div className="gfacts" data-reveal>
            ...
            <div className="fact"><b>11–18</b><span>років</span></div>
          </div>
        </div>
      </div>
