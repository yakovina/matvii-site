      ...
      <div className="group-hero on-dark">
        <div className="wrap group-hero-grid">
          <div>
            ...
            <p className="lead">
              У 5–10 років найкраще працює гра: на зустрічах ми граємо, малюємо, будуємо світи
              в пісочниці — і через це дитина вчиться розуміти свої емоції та справлятися з
              ними.
            </p>
