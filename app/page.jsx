      ...
      <div className="hero">
        <div className="wrap hero-grid">
          <div>
            ...
            <p className="lead">
              Дитячий психолог у Києві та онлайн. Працюю з дітьми 5–10 років і підлітками
              11–18. На зустрічах поєдную гру та розмову, а батькам даю конкретні рекомендації
              й інструменти, які можна використовувати вдома.
            </p>
      ...
      <section style={{ paddingTop: 0 }}>
        <div className="wrap">
          <div className="quiz-cta" data-reveal>
            ...
            <p>
              Іноді складно зрозуміти, де звичайні вікові зміни, а де привід звернутися до
              психолога. Відмітьте, які з 12 щоденних ситуацій про вашу родину, і тест
              розкаже, що з цим робити.
            </p>
