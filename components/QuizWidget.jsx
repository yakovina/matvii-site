  ...
  if (idx === -1) {
    return (
      <div className="quiz-card">
        ...
        <p className="muted">
          Тут зібрані звичайні моменти з життя з дитиною: вечері, істерики, домашка, друзі.
          Просто відмічайте, наскільки це про вас. А в кінці я розкажу, що почув у ваших
          відповідях, що можна спробувати вдома вже сьогодні — і з чого почати, якщо захочете
          підтримки.
        </p>
