...
const AREA_INSIGHTS = {
  emotions: {
    ...
    heard:
      'Найбільше напруги зараз у сфері емоцій: дитині складно втримувати сильні почуття, і вони виливаються дією — криком, сльозами, вибухами. Це не «поганий характер» і не помилки виховання. Це навичка, якої поки немає, — а навички тренуються.',
  ...
  social: {
    ...
    heard:
      'Найчутливіша точка зараз — стосунки з іншими дітьми: влитися в компанію, витримати відмову чи програш, вирішити конфлікт. Ці вміння неможливо пояснити на словах — вони тренуються тільки в живій взаємодії.',
  ...
  family: {
    ...
    heard:
      'Схоже, втомилася вся родина: правила не працюють, прохання повторюються по колу, і напруга накопичується в усіх. Це не тому, що ви «не справляєтесь» — просто система застрягла, і їй потрібен погляд ззовні.',
    tip: 'Спробуйте тиждень «одного правила»: оберіть єдине, найважливіше, і помічайте, коли воно виконується («Дякую, що сів за уроки сам»). Десять правил одночасно не працюють ні в кого.',
  },
  stress: {
    name: 'реакція на стрес',
    heard:
      'Поведінка і тіло дитини зараз говорять те, що вона не може сказати словами: пережите досі всередині. Так психіка захищається — і їй можна допомогти випустити це безпечно.',
  ...
  if (idx === -1) {
    return (
      <div className="quiz-card">
        ...
        <p className="muted">
          Це не клінічний опитувальник, а дзеркало щоденних моментів. Відповідайте, як воно є
          зараз, а не як «має бути». У кінці — не бали, а людська відповідь: що ми почули, що
          спробувати вдома вже сьогодні і з чого почати, якщо потрібна підтримка.
        </p>
      ...
      level === 'low'
        ...
        : level === 'mid'
          ...
          : isTeen
            ...
            : 'Почніть із сімейної зустрічі-знайомства: дитина побачить, що психолог — це безпечно, а ми визначимо план. Ви в цьому процесі не самі.';
      ...
      <div className="quiz-card quiz-result" style={{ textAlign: 'left' }}>
        ...
        <div className="quiz-block">
          ...
          <p className="muted">{level === 'low'
            ? 'Більшість описаного схоже на звичайні вікові прояви. Якщо десь і є напруга, то найпомітніша вона у сфері «' + insight.name + '» — але за вашими відповідями вона не виглядає критичною.'
            : insight.heard}</p>
        </div>
        ...
        <p className="quiz-disclaimer" style={{ textAlign: 'center' }}>
          Цей тест — орієнтир для батьків, а не психологічний чи медичний висновок. Якщо ви
          тривожитесь за дитину — довіряйте своєму відчуттю незалежно від результату.
        </p>
      </div>
    );
  }
