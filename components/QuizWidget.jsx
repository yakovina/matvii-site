  ...
  if (idx === -1) {
    return (
      <div className="quiz-card">
        ...
        <p className="muted">
          Це дзеркало щоденних моментів із життя вашої родини. Відповідайте, як воно є зараз.
          У кінці отримаєте короткий підсумок: що ми почули у ваших відповідях, що спробувати
          вдома вже сьогодні і з чого почати, якщо захочете підтримки.
        </p>
